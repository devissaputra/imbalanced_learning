...
Target encoding in scikit-learn is 0 = malignant and 1 = benign. For this experiment I create a controlled imbalance from the original observations:

- all 212 class-0 (malignant) rows are kept;
- 35 class-1 (benign) rows are selected with a seeded random sample;
